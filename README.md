...
1) По отладке ошибок составлен отчет ****report.pdf****

2) Код с ошибками расположен в **src_buggy** в services/casino.py и models/gooses.py

3) Код с ошибками расположен в **src_fixed** в services/casino.py и models/gooses.py

4) Ошибки и их исправления можно искать по ключевым словам: **ОШИБКА** и **ИСПРАВЛЕНИЕ** в соответствующих папках
